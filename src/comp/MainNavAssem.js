...
<a style={{width:"20%",backgroundColor:" #ffff",paddingTop:"5px"}}> <img src='./cognito_logo.jpeg' href="/" style={ { height:"50px", width:"150px", margin:"0px"}}></img></a>   
 <Navbar style = {{backgroundColor:"#4a87e8",width:"80%" }} variant="dark" expand="lg" sticky="top" >
    
     <h4 style = {{color:"#fff", marginLeft:"20%"}}> Assembly {this.props.data}</h4>
